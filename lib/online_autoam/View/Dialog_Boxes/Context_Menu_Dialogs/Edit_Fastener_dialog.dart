      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () {
                chosing_fastener_type = !chosing_fastener_type;
                setState(() {});
              },
              child: Container(
                height: 40,
                          ...
                          child: Center(
                            child: InkWell(
                              onTap: () {
                                ...
                                Fastener_Templet temp = draw_controller
                                    .box_repository.dowel_templet;
                                if (templets_names[i] == "mini fix") {
                                  temp =
                                      draw_controller.box_repository.mini_fix;
                                } else if (templets_names[i] ==
                                    "confirm screw") {
                                  temp = draw_controller
                                      .box_repository.confirm_screw;
          ...
          InkWell(
            onTap: (){
              draw_controller.flip_fasteners();
            },
            child: Container(
              width: 200,height: 50,child: Text("flip fastener"),
            ),
          ),
